...
public extension Calendar {
    ...
    public func weekdayOrdinal(of date: Date) -> Int {
        return component(.weekdayOrdinal, from: date)
    }
    ...
    public func yearForWeekOfYear(of date: Date) -> Int {
        return component(.yearForWeekOfYear, from: date)
    }
    ...
    public func commonComponents(of date: Date) -> DateComponents {
        return dateComponents(Date.commonComponents, from: date)
    }
    /// Extracts all date components for date
    public func allComponents(of date: Date) -> DateComponents {
        return dateComponents(Date.allComponents, from: date)
    }
}
